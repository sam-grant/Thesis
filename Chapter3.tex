...
% of highly polarised positive muons at ±2\% of the magic momentum, 3.094 GeV, are sent to the E989 experiment hall, where they pass through four electromagnetic focusing quadrupoles before being injected into the storage ring. Further discussion on the accelerator complex and muon delivery to E989 may be found in \cite{FermilabBeamline}. 

% Finally, a beam of highly polarised positive muons at the magic momentum, 3.094 GeV, are sent to the E989 experiment hall, where they pass through four electromagnetic focusing quadrupoles before being injected into the storage ring. 
...
% Inflector
%As well be expanded upon later in this chapter, the `yoke'\footnote{\myworries{Check this}} of E989 main magnet is a monolithic iron  
...
% trim={0 0 0 0},clip,width=.69\textwidth
...
% Since the momentum vectors of the individual muons are not perfectly aligned with tangent of the ideal storage radius, and have some vertical component, 
...
%
\begin{equation}
  n = \frac{\kappa R_{0}}{v B_{0}} %\frac{R_{0}}{vB_{0}}\frac{\partial E}{\partial y} % = \frac{\kappa R_{0}}{v B_{0}} % \approx \frac{\kappa R_{0}}{c B_{0}},
...
% \begin{figure}[t!]
% \centering{}
% \includegraphics[trim={0 0 0 0},clip,width=.69\textwidth]{example-image}
% \caption{A photograph the kicker plates mounted in the storage ring vacuum chamber.}
% \label{fig:Quads}
% \end{figure}
...
% \begin{equation}
%   f_{\text{CBO}} = f_{c} - f_{x_{\text{BO}}}
%   \label{eqn:CyclotronFrequency}
% \end{equation}
...
% Representations of the E989 auxiliary detector systems, showing: (a) a schematic of the T0 counter, showing the scintillator (green) attached to PMTs on the left and right, which is mounted upstream of the inflector for the primary purpose of defining the initial time of the fill; (b) a computer model of one the IBMS detectors (IBMS1), showing the grid of scintillating fibres used to make a measurement of the spatial distribution of the beam upstream of the inflector; (c) a photograph of one of the four fibre harps, showing the scintillating fibres (horizontally aligned in this case) mounted on a retractable arm, which are used to make a destructive measurement of the spatial distribution of the beam inside the storage ring vacuum chamber. 
...
% \begin{figure}[t!]
% \centering{}\textit{Hamamatsu}
% \includegraphics[trim={0 0 0 0},clip,width=.69\textwidth]{Images/Chapter3/CaloIllustration.pdf}
% \caption{A rendering of three calorimeters in position during operation, with an incident decay positron indicated by a blue line; (b) a photograph of the $\text{PbFl}_{2}$ crystals and SiPMs during assembly. Image reproduced from \cite{CaloCommissioning}.}
% \label{fig:CaloModel}
% \end{figure}

% \begin{figure}[t!]
% \centering{}
% \includegraphics[trim={0 1.2cm 0 0},clip,width=.69\textwidth]{Images/Chapter3/CaloCrystals.png}
% \caption{A photograph of the $\text{PbFl}_{2}$ crystals and SiPMs during assembly. Image reproduced from \cite{CaloCommissioning}.}
% \label{subfig:CaloCrystals}
% \end{figure} 
...
%{Additionally, the calorimeters must be able to distinguish two clusters of crystal hits at an efficiency of 100\% if those hits are more than \SI{5}{\nano\second} apart, and at an efficiency 66\% if they are less than  those hits separated by less \SI{5}{\nano\second} apart.}
...
% \begin{figure}[t!]
% \centering{}
% \includegraphics[trim={0 0 0 0},clip,width=.69\textwidth]{Images/Chapter3/Tracker-InVac.png}
% \caption{A photograph taken from the interior of the vacuum chamber, showing a tracker station from the perspective of the muon beam. Image courtesy of the E989 collaboration.}
% \label{subfig:TrackerInVac}
% \end{figure} 

% To extrapolate tracks, a method 

%  making use of the relationship between drift time and distance.  which adTime islands are further refined in `track candidates' by checking for significant gaps in time and space between straw hits. 

% \myworries{I need some information on tracker performance and track extrapolation. Unfortunately information on the extrapolation resolution. Discuss how you get momentum from the curling of tracks through the magnetic field. What is the vertical angle resolution? Also, $25\degree$ (3 m) azimuthal acceptance.}



% Performance? What's the resolution, when do they start taking data, maybe throw in a plot? What about acceptance. Not sure. 
